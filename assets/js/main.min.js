...
function add_item_to_table(e, t, a, i) {
    ...
    if ("" !== (e = void 0 === e || "undefined" == e ? get_item_preview_values() : e).description || "" !== e.long_description || "" !== e.rate) {
        ...
        return get_taxes_dropdown_template(l, e.taxname).done((function(a) {
            ...
            var supplierIemVal = $('input[name="supplier_item_data_checkbox"]:checked').val();
  
            if(supplierIemVal){
                var supplierIemValParse = $.parseJSON(supplierIemVal);
                var supplierIemSupplierId = supplierIemValParse.supplier_id;
                var supplierIemValJsonString = JSON.stringify(supplierIemVal).replace(/"/g, '&quot;');
            } else {
                // alert('Select Supplier Item');
            ...
            $('#dynamicTableBody').html('<tr><td colspan="5" class="text-center">No selected any item yet</td></tr>');
